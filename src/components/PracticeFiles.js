            ...
            <div className="servicesWrap portfolioWrap" id="myProject">
                <div className="servicesInside">
                    <div className="servicesRow1">
                        ...
                        <p> My Practice Projects</p>
                    </div>
                    
                    <div className="subheading">
                        <p><span className="servicessubtext">Latest</span> Practice Projects built by me . . .</p>
                    ...
                    <div>
                        <div className="servicesMainUnit">
                            {PracticeProjectUtility.map((data)=>{
                                return (
                                    <>
